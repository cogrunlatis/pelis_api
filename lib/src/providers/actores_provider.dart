...
class ActoresProvider {
  ...
  Future<List<Actor>> getCast(String personId) async {
    final url = Uri.https(_url, '3/person/$personId/combined_credits', {'api_key': _apikey, 'language': _language});  // pelicula
